...
CONFIG["ppo_large"]["train_batch_size"] = 2048 * 40 #8192 * 8 * 4
CONFIG["ppo_large"]["sgd_minibatch_size"] = 2048 #4096
CONFIG["ppo_large"]["trainer_config"]["muscle_sgd_minibatch_size"] = 2048 #4096
CONFIG["ppo_large"]["trainer_config"]["marginal_sgd_minibatch_size"] = 2048 #4096
CONFIG["ppo_large"]["trainer_config"]["ref_sgd_minibatch_size"] = 2048 #4096

# Medium Set (For a node or a PC)
CONFIG["ppo_medium"] = copy.deepcopy(CONFIG["ppo"])
CONFIG["ppo_medium"]["train_batch_size"] = 2048 * 60 # 8192 * 4 * 2
...
CONFIG["ppo_small"]["train_batch_size"] = 2048 * 24 //4
CONFIG["ppo_small"]["sgd_minibatch_size"] = 512 * 2
CONFIG["ppo_small"]["trainer_config"]["muscle_sgd_minibatch_size"] = 512 * 2
CONFIG["ppo_small"]["trainer_config"]["marginal_sgd_minibatch_size"] = 512 * 2
CONFIG["ppo_small"]["trainer_config"]["ref_sgd_minibatch_size"] = 512 * 2
...
CONFIG["ppo_large_server"]["num_workers"] = 40 #128 * 4
...
CONFIG["ppo_medium_pc"]["num_workers"] = 60
